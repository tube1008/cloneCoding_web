/* 
    container(아이템 수백개 보이는 부모영역)안에서 item(개별 아이템)요소들을 data.js(DB) 에서 가져온다.
    DB -> <p class="photo"><img src="" alt=""></p>
    DB -> <h2></h2>
    DB -> <p class="price"></p>

    DB 데이터를 가져오기 위해 필요한 요소 = div, p, h2, p
    디자인 또는 동적 기능을적용하기 위한 클래스 선언 필요 = item, photo, price
*/

const container = document.querySelector('.container') // item 부모선언
